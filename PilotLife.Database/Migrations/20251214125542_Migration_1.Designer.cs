...
namespace PilotLife.Database.Migrations
{
    ...
    [Migration("20251214125542_Migration_1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PilotLife.Database.Entities.Aircraft", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PilotLife.Database.Entities.AircraftRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PilotLife.Database.Entities.AircraftRequest", b =>
                {
                    b.HasOne("PilotLife.Database.Entities.User", "RequestedByUser")
                        .WithMany()
                        .HasForeignKey("RequestedByUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PilotLife.Database.Entities.User", "ReviewedByUser")
                        .WithMany()
